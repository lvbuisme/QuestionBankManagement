...
{
    public class DeleteQuestionBackToManagerPaper : ICommand
    {
        public event EventHandler CanExecuteChanged;
        private ExaminationPaperManagerViewModel _addExaminationPaperViewModel;
        public DeleteQuestionBackToManagerPaper(ExaminationPaperManagerViewModel addExaminationPaperViewModel)
        {
